...
export const auth: Dict = {
  ...
  'pwa.installTitle': { bn: 'LifeTrack ইনস্টল করুন', en: 'Install LifeTrack' },
  'pwa.installDescription': {
    bn: 'দ্রুত ব্যবহারের জন্য অ্যাপটি হোম স্ক্রিনে যুক্ত করুন',
    en: 'Add the app to your home screen for quick access',
  },
  'pwa.installButton': { bn: 'ইনস্টল করুন', en: 'Install' },
  'pwa.later': { bn: 'পরে', en: 'Later' },
  'pwa.manualHint': {
    bn: 'ডেস্কটপ/মোবাইল মেনু থেকে "Install" বা "Add to Home Screen" অপশন ব্যবহার করুন',
    en: 'Use the "Install" or "Add to Home Screen" option from your desktop/mobile browser menu',
  },
  'pwa.installSuccess': { bn: 'অ্যাপ সফলভাবে ইনস্টল হয়েছে!', en: 'PWA installed successfully!' },
  'pwa.installCancelled': { bn: 'ইনস্টল বাতিল হয়েছে', en: 'Install cancelled' },
  'pwa.installError': { bn: 'ইনস্টল করতে সমস্যা হয়েছে', en: 'Failed to install' },
  'pwa.manualInstructionsTitle': { bn: 'ম্যানুয়াল ইনস্টল নির্দেশনা', en: 'Manual install instructions' },
  'pwa.manualDesktop': { bn: 'অ্যাড্রেস বারে ইনস্টল আইকন', en: 'Install icon in the address bar' },
  'pwa.iosGuideTitle': { bn: 'iPhone / iPad-এ যেভাবে যুক্ত করবেন', en: 'Add on iPhone / iPad' },
