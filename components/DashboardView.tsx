...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const arrived = (key: string) => {
      seen.add(key)
      // Reveal as soon as the money data (debts + loans) lands — the hero and
      // tiles need only those. Reminders drive a top banner that can pop in a
      // moment later, so don't hold the whole screen waiting on all three.
